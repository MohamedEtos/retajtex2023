				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='') }}">فنيل حراري</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='') }}">المكبس</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='#') }}">الحضور والانصراف</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='#') }}">الخصومات</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='#') }}">الامنح والمكافئات</a></li>
						</ul>
					</li>
