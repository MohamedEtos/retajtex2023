					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown nav-item main-header-message ">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											<h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold">التعليقات</h6>
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"></span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">قائمه التعليقات في الموقع</p>
									</div>
									<div class="main-message-list chat-scroll">
										...
										<a href="#" class="p-3 d-flex border-bottom">
											<div class="  drop-img  cover-image  " data-image-src="{{URL::asset('avatars/')}}/{{$commint->users_ship->avatar}}">
												<span class="avatar-status bg-teal"></span>
											</div>
											<div class="wd-90p">
												<div class="d-flex">
													<h5 class="mb-1 name">{{$commint->users_ship->name}}</h5>
												</div>
												<p class="mb-0 desc">{{$commint->commint}}</p>
												<p class="time mb-0 text-left float-right mr-2 mt-2">{{$commint->created_at}}</p>
											</div>
										</a>

										@empty
											<h5 class="text-center m-3">لا يوجد تعليقات</h5>
										@endforelse
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('avatars/')}}/{{Auth::user()->avatar}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('avatars/')}}/{{Auth::user()->avatar}}" class=""></div>
