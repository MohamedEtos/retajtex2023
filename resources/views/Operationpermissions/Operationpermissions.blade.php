                ...
                <form action="{{url('sublimation/store')}}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row mb-2">
                            <div class="col-md-4 col-sm-6 mt-4">
                                ...
                                <input type="text" class="form-control" id="ptint_type" name="ptint_type" placeholder="عدد القطع او نوع الطباعه">
                            </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4 col-sm-6 mt-4">
                            ...
                            <input type="text" class="form-control form-control-lg" id="designer" value="{{Auth::User()->name}}" name="who_signed_order" >
                        </div>
