...
@endif
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{url('Operationpermissions/storeFrompermissions')}}" method="POST" enctype="multipart/form-data"
                        autocomplete="on">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4 col-sm-6 mt-4">
                                ...
                                <select name="designer" id="designer" class="form-control" >
                                    <option selected value="{{$dataFromPermss->designer}}">{{$dataFromPermss->designer}}</option>
...
{{--
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-sm-12 col-md-5 mt-4">
                                ...
                                <textarea class="form-control" id="note" value='{{$dataFromPermss->note}}' name="note" rows="5"></textarea>
                                <div class="row mt-4">
                                    <div class="col-sm-12 col-md-4 mt-4">
                                        <button type="submit" class="btn btn-primary ">حفظ البيانات</button>
                                        <a href="{{url('Operationpermissions')}}"  class="btn btn-outline-danger ">الغاء</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-3 mt-4">
                                <label for="">رفع صورة جديده</label>
                                <label for="" class="text-warning"> المتاحه Jpg / Png / Pdf / Jpeg </label>
                                <input type="file" value="" name="pic" class="dropify" accept=".pdf,.jpg, .png, image/jpeg, image/png"
                                    data-height="107" />
                            </div>
